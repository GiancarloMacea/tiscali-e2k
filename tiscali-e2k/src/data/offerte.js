// ─── DATI TISCALI — Luglio 2026 ──────────────────────────────────────────────
// Allineato al Portafoglio Offerte ufficiale (canvass) Luglio 2026.
// Generato con AI Claude.
...
export const DATI = {
  ...
  residenziale: {
    mobile: [
      // ── 5,99€ — DUE PRODOTTI DISTINTI ─────────────────────────────────────
      {
        ...
        features: ['150 GB in 5G · fino a 250 Mega', 'Minuti illimitati · 100 SMS', '✅ Portabilità da TUTTI gli operatori (inclusi TIM e Kena)'],
        ...
        dettagli: {
          ...
          'Rete': '5G con velocità fino a 250 Mega in download.',
      ...
      // ── 7,99€ — TRE PRODOTTI DISTINTI ─────────────────────────────────────
      {
        ...
        features: ['250 GB in 5G · fino a 1 Giga', 'Minuti illimitati · 100 SMS', '⚠️ Solo portabilità da TIM o Kena'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica': '10€' },
        dettagli: {
          ...
          'Rete': '5G con velocità fino a 1 Giga in download in base alla copertura.',
          'Traffico extra soglia': 'Bloccato automaticamente. Sblocco tramite Area Clienti: 30 cent/MB.',
          'Pagamento': 'Ricarica automatica su RID/Carta. Mancato pagamento: ricarica manuale allo stesso prezzo.',
          'Servizi inclusi': 'Parental Control Safe Kids Free by Kaspersky incluso.',
        },
      },
      {
        ...
        features: ['250 GB in 5G · fino a 1 Giga', 'Minuti illimitati · 100 SMS', '📱 Portabilità esclusi TIM e Kena'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica': '10€' },
        dettagli: {
      ...
      },
      {
        ...
        highlight: false,
        target: { label: '🆕 Solo nuovo numero', color: 'green' },
        features: ['250 GB in 5G · fino a 1 Giga', 'Minuti illimitati · 100 SMS', '🆕 Solo nuove numerazioni'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica': '10€' },
        dettagli: {
      ...
      // ── 10,99€ — TRE PRODOTTI DISTINTI ────────────────────────────────────
      {
        ...
        highlight: true,
        target: { label: '🔴 Solo TIM  🔵 Solo Kena', color: 'timkena' },
        features: ['350 GB in 5G · fino a 2 Giga', 'Minuti illimitati · 100 SMS', '⚠️ Solo portabilità da TIM o Kena'],
        ...
        dettagli: {
          ...
          'Rete': '5G con velocità fino a 2 Giga in download in base alle aree di copertura.',
          'Traffico extra soglia': 'Bloccato automaticamente. Sblocco tramite Area Clienti: 30 cent/MB.',
          'Pagamento': 'Ricarica automatica su RID/Carta. Mancato pagamento: ricarica manuale allo stesso prezzo.',
          'Servizi inclusi': 'Parental Control Safe Kids Free by Kaspersky incluso.',
        },
      },
      {
        ...
        highlight: true,
        target: { label: '📱 Portabilità esclusi TIM e Kena', color: 'orange' },
        features: ['350 GB in 5G · fino a 2 Giga', 'Minuti illimitati · 100 SMS', '📱 Portabilità esclusi TIM e Kena'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica': '15€' },
        dettagli: {
      ...
      },
      {
        ...
        highlight: false,
        target: { label: '🆕 Solo nuovo numero', color: 'green' },
        features: ['350 GB in 5G · fino a 2 Giga', 'Minuti illimitati · 100 SMS', '🆕 Solo nuove numerazioni'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica': '15€' },
        dettagli: {
      ...
      // ── SMART CONNECT ──────────────────────────────────────────────────────
      {
        ...
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica iniziale': '30€' },
        dettagli: {
          ...
          'Valida anche P.IVA': 'Attivabile anche con Partita IVA (costi IVA esclusa ad eccezione delle ricariche).',
    ...
    fisso: [
      // ══ FTTH ═══════════════════════════════════════════════════════════════
      {
        ...
        highlight: false,
        tecnologia: 'FTTH',
        features: ['FTTH fino a 2.5 Gbps', '⚠️ Chiamate a consumo (non illimitate)', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          ...
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di attivazione di 120€ suddiviso in 24 rate da 5€/mese — già incluse nel canone, non aggiuntive. In caso di recesso anticipato le rate residue vengono addebitate.',
      ...
      },
      {
        ...
        highlight: true,
        tecnologia: 'FTTH',
        features: ['FTTH fino a 2.5 Gbps', 'Chiamate illimitate verso fissi e mobili nazionali', 'Assicurazione casa e digitale AXA inclusa', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          '📍 Cos\'è l\'installazione (29,90€)': 'Costo Una Tantum addebitato nella prima fattura. Il tecnico Tiscali viene fisicamente a posare il cavo fibra. Standard: entro 5m dall\'ingresso. Oltre 5m fino a 20m: +60€. Oltre 20m: +6€/metro.',
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di attivazione di 120€ suddiviso in 24 rate da 5€/mese — già incluse nel canone, non aggiuntive.',
        ...
        postille: ['* Prezzo promo 22,90€/mese per i primi 12 mesi. Dal 13° mese: 27,90€/mese.', 'Installazione: 29,90€ Una Tantum in prima fattura.', 'Attivazione: 120€ in 24 rate da 5€/mese — già incluse nel canone.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.'],
      },
      // ══ FTTC — ULTRAINTERNET ═══════════════════════════════════════════════
      {
        id: 'res-fis-3',
        nome: 'Casa Ultrainternet',
        sub: 'FTTC fino a 200 Mega · Solo fisso',
        prezzo: 19.90, label: '19,90€', suf: '/mese*',
        highlight: false,
        tecnologia: 'FTTC',
        features: ['FTTC fino a 200 Mega', '⚠️ Chiamate a consumo (non illimitate)', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          'Tecnologia': 'FTTC (fibra fino all\'armadio + rame fino a casa) — velocità fino a 200 Mega in download in base alla distanza dalla centralina.',
          '📍 Cos\'è l\'installazione (29,90€)': 'Costo Una Tantum addebitato nella prima fattura per l\'intervento tecnico.',
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di 120€ in 24 rate da 5€/mese — già incluse nel canone, non aggiuntive.',
          '⚠️ Chiamate': 'A consumo — NON incluse illimitate. Home Safe include chiamate illimitate.',
          'Promozione': 'Prezzo promo per i primi 12 mesi. Dal 13° mese: 25,90€/mese.',
        },
        postille: ['* Prezzo promo 19,90€/mese per i primi 12 mesi. Dal 13° mese: 25,90€/mese.', 'Installazione: 29,90€ Una Tantum. Attivazione: 120€ in 24 rate da 5€/mese incluse nel canone.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.', '⚠️ Chiamate a consumo — passare a Home Safe per illimitate.'],
      },
      {
        id: 'res-fis-4',
        nome: 'Casa Ultrainternet Home Safe',
        sub: 'FTTC 200 Mega + Assicurazione AXA inclusa',
        prezzo: 22.90, label: '22,90€', suf: '/mese*',
        highlight: false,
        tecnologia: 'FTTC',
        features: ['FTTC fino a 200 Mega', 'Chiamate illimitate verso fissi e mobili nazionali', 'Assicurazione casa e digitale AXA inclusa', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          'Tecnologia': 'FTTC (fibra + rame) — fino a 200 Mega in download in base alla distanza dalla centralina.',
          'AXA Casa': 'Intervento professionista. Fino a 200€/sinistro, max 3 sinistri/anno. Copertura albergo per inagibilità fino a 1.500€.',
          'AXA Digitale': 'Fino a 2 interventi/anno Mobile e 3 interventi/anno Home.',
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di 120€ in 24 rate da 5€/mese — già incluse nel canone.',
          'Promozione': 'Prezzo promo per i primi 12 mesi. Dal 13° mese: 27,90€/mese.',
        },
        postille: ['* Prezzo promo 22,90€/mese per i primi 12 mesi. Dal 13° mese: 27,90€/mese.', 'Installazione: 29,90€ Una Tantum. Attivazione: 120€ in 24 rate da 5€/mese incluse nel canone.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.'],
      },
      // ══ FWA 5G TISCALI ═════════════════════════════════════════════════════
      {
        id: 'res-fis-5',
        nome: 'Casa FWA 5G',
        sub: 'FWA 5G fino a 300 Mega · Solo fisso',
        prezzo: 19.90, label: '19,90€', suf: '/mese*',
        highlight: false,
        tecnologia: 'FWA5G',
        features: ['FWA 5G fino a 300 Mega', '⚠️ Chiamate a consumo (non illimitate)', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          'Tecnologia': 'FWA 5G (Fixed Wireless Access) — fino a 300 Mega in download in base alla copertura 5G. Verificare sempre la copertura prima dell\'attivazione.',
          '📍 Cos\'è l\'installazione (29,90€)': 'Costo Una Tantum addebitato nella prima fattura per l\'intervento tecnico.',
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di 120€ in 24 rate da 5€/mese — già incluse nel canone, non aggiuntive.',
          '⚠️ Chiamate': 'A consumo — NON incluse illimitate. Home Safe include chiamate illimitate.',
          'Promozione': 'Prezzo promo per i primi 12 mesi. Dal 13° mese: 25,90€/mese.',
        },
        postille: ['* Prezzo promo 19,90€/mese per i primi 12 mesi. Dal 13° mese: 25,90€/mese.', 'Installazione: 29,90€ Una Tantum. Attivazione: 120€ in 24 rate da 5€/mese incluse nel canone.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.', 'Offerta soggetta a limiti geografici e di copertura 5G.'],
      },
      {
        id: 'res-fis-6',
        nome: 'Casa FWA 5G Home Safe',
        sub: 'FWA 5G 300 Mega + Assicurazione AXA inclusa',
        prezzo: 22.90, label: '22,90€', suf: '/mese*',
        highlight: false,
        tecnologia: 'FWA5G',
        features: ['FWA 5G fino a 300 Mega', 'Chiamate illimitate verso fissi e mobili nazionali', 'Assicurazione casa e digitale AXA inclusa', 'Modem Super Wi-Fi in comodato gratuito'],
        costi: { '📍 Installazione tecnico (Una Tantum)': '29,90€', '🔄 Attivazione (rateizzata)': '120€ in 24 rate da 5€ — già incluse nel canone' },
        dettagli: {
          'Tecnologia': 'FWA 5G — fino a 300 Mega in download in base alla copertura 5G. Verificare sempre la copertura prima dell\'attivazione.',
          'AXA Casa': 'Intervento professionista. Fino a 200€/sinistro, max 3 sinistri/anno. Copertura albergo per inagibilità fino a 1.500€.',
          'AXA Digitale': 'Fino a 2 interventi/anno Mobile e 3 interventi/anno Home.',
          '🔄 Attivazione (120€ in 24 rate)': 'Contributo di 120€ in 24 rate da 5€/mese — già incluse nel canone.',
          'Promozione': 'Prezzo promo per i primi 12 mesi. Dal 13° mese: 27,90€/mese.',
        },
        postille: ['* Prezzo promo 22,90€/mese per i primi 12 mesi. Dal 13° mese: 27,90€/mese.', 'Installazione: 29,90€ Una Tantum. Attivazione: 120€ in 24 rate da 5€/mese incluse nel canone.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.', 'Offerta soggetta a limiti geografici e di copertura 5G.'],
      },
    ...
    convergente: [
      // ══ FTTH + MOBILE ══════════════════════════════════════════════════════
      {
        ...
        sub: 'FTTH + Mobile · Prezzo fisso garantito',
      ...
      },
      {
        ...
        sub: 'FTTH + Mobile 5G · Prezzo fisso garantito',
        prezzo: 23.90, label: '23,90€', suf: '/mese fisso',
        highlight: false,
        tecnologia: 'FTTH',
        ...
        costi: { '📍 Installazione tecnico fisso (Una Tantum)': '29,90€', '🔄 Attivazione commerciale fisso': 'Inclusa nel canone', 'SIM': '10€', 'Attivazione SIM': 'Gratis', 'Ricarica SIM': '10€', 'SIM mensile': '+9,90€/mese' },
        dettagli: {
          '📍 Installazione vs Attivazione': 'INSTALLAZIONE (29,90€ Una Tantum): il tecnico viene fisicamente a posare il cavo fibra — paghi una sola volta nella prima fattura. ATTIVAZIONE COMMERCIALE: per questa offerta è inclusa nel canone, nessun costo aggiuntivo.',
      ...
      {
        id: 'res-conv-3',
        nome: 'Casa Ultrainternet Home Safe + Mobile 200 GB',
        sub: 'FTTC + Mobile · Prezzo fisso garantito',
        prezzo: 23.90, label: '23,90€', suf: '/mese fisso',
        highlight: false,
        tecnologia: 'FTTC',
        features: ['FTTC fino a 200 Mega · Prezzo fisso garantito', 'Chiamate illimitate · 60 min/mese int.', 'Assicurazione AXA inclusa', 'SIM 200 GB: +6€/mese'],
        costoTotale: { label: '29,90€/mese', nota: 'Fisso 23,90€ + SIM 6,00€' },
        costi: { '📍 Installazione tecnico fisso (Una Tantum)': '29,90€', '🔄 Attivazione commerciale fisso': 'Inclusa nel canone', 'SIM': '10€', 'Attivazione SIM': 'Gratis', 'Ricarica SIM': '10€', 'SIM mensile': '+6€/mese' },
        dettagli: {
          'Tecnologia': 'FTTC (fibra + rame) — fino a 200 Mega in download in base alla distanza dalla centralina.',
          'Roaming mobile': '8,94 GB disponibili in zona EU per l\'offerta Mobile 200 GB Pro.',
          'AXA inclusa': 'Tutela Casa e Assistenza Digitale.',
          'Vincoli': 'Se si disattiva la SIM, il Fisso passa a 27,90€/mese. Recesso fisso entro 24 mesi: penale pari a 1 mensilità.',
        },
        postille: ['* Totale 29,90€/mese (fisso 23,90€ + SIM 6€). Prezzo fisso garantito.', 'Installazione fisso: 29,90€ Una Tantum. SIM: 10€ + prima ricarica 10€.', 'Se si disattiva la SIM: il canone fisso sale a 27,90€/mese.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.', 'SIM valida per nuove numerazioni e portabilità da tutti gli operatori.'],
      },
      {
        id: 'res-conv-4',
        nome: 'Casa Ultrainternet Home Safe + Mobile 350 GB 5G',
        sub: 'FTTC + Mobile 5G · Prezzo fisso garantito',
        prezzo: 23.90, label: '23,90€', suf: '/mese fisso',
        highlight: false,
        tecnologia: 'FTTC',
        features: ['FTTC fino a 200 Mega · Prezzo fisso garantito', 'Chiamate illimitate · 60 min/mese int.', 'Assicurazione AXA inclusa', 'SIM 350 GB 5G: +9,90€/mese'],
        costoTotale: { label: '33,80€/mese', nota: 'Fisso 23,90€ + SIM 9,90€' },
        costi: { '📍 Installazione tecnico fisso (Una Tantum)': '29,90€', '🔄 Attivazione commerciale fisso': 'Inclusa nel canone', 'SIM': '10€', 'Attivazione SIM': 'Gratis', 'Ricarica SIM': '10€', 'SIM mensile': '+9,90€/mese' },
        dettagli: {
          'Tecnologia': 'FTTC (fibra + rame) — fino a 200 Mega in download in base alla distanza dalla centralina.',
          'Roaming mobile': '14,75 GB disponibili in zona EU per l\'offerta Mobile 350 GB Pro 5G.',
          'AXA inclusa': 'Tutela Casa e Assistenza Digitale PC/Smartphone.',
          'Vincoli': 'Se si disattiva la SIM, il Fisso passa a 27,90€/mese. Recesso fisso entro 24 mesi: penale pari a 1 mensilità.',
        },
        postille: ['* Totale 33,80€/mese (fisso 23,90€ + SIM 9,90€). Prezzo fisso garantito.', 'Installazione fisso: 29,90€ Una Tantum. SIM: 10€ + prima ricarica 10€.', 'Se si disattiva la SIM: il canone fisso sale a 27,90€/mese.', 'In caso di cessazione entro 24 mesi: 1 mensilità + rate residue.', 'SIM valida per nuove numerazioni e portabilità da tutti gli operatori.'],
      },
  ...
  business: {
    mobile: [
      {
        id: 'biz-mob-1',
        nome: 'Business Mobile 250',
        sub: '9,99€+IVA · 250 GB 4G · Nuove attivazioni e portabilità',
        prezzo: 9.99, label: '9,99€', suf: '+IVA/mese',
        iva: true, highlight: false,
        target: { label: '📱 Nuovi numeri + portabilità', color: 'blue' },
        features: ['250 GB in 4G · fino a 150 Mbps', 'Minuti illimitati · 200 SMS', 'Nuove attivazioni e portabilità da tutti gli operatori'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€' },
        dettagli: {
          '📋 Riservata a': 'Nuove attivazioni e portabilità del numero da tutti gli operatori con Partita IVA.',
          'Rete': '4G con velocità fino a 150 Mbps in download.',
          'Roaming EU': '18,16 GB disponibili in roaming EU. Minuti e SMS utilizzabili come in Italia.',
          'IVA': 'Prezzo IVA esclusa (22%), ad eccezione delle ricariche.',
          'Traffico extra soglia': '30 cent/MB.',
        },
      },
      {
        id: 'biz-mob-2',
        nome: 'Business Mobile 400 5G',
        sub: '11,99€+IVA · 400 GB 5G · Portabilità da tutti gli operatori',
        prezzo: 11.99, label: '11,99€', suf: '+IVA/mese',
        iva: true, highlight: true,
        target: { label: '📱 Portabilità tutti gli operatori', color: 'orange' },
        features: ['400 GB in 5G · fino a 2 Gbps', 'Minuti illimitati · 200 SMS', 'Portabilità del numero da tutti gli operatori'],
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€' },
        dettagli: {
          '📋 Riservata a': 'Portabilità del numero da tutti gli operatori con Partita IVA.',
          'Rete': '5G con velocità fino a 2 Gbps in download in base alla copertura.',
          'Roaming EU': '21,80 GB disponibili in roaming EU. Minuti e SMS utilizzabili come in Italia.',
          'IVA': 'Prezzo IVA esclusa (22%), ad eccezione delle ricariche.',
          'Traffico extra soglia': '30 cent/MB.',
        },
      },
      {
        ...
        sub: '1,99€+IVA · 100 MB · Domotica e dispositivi connessi',
        ...
        costi: { 'Attivazione': 'Gratis', 'SIM': '10€', 'Ricarica iniziale': '30€' },
        dettagli: {
          '📋 Riservata a': 'Servizi di domotica — dispositivi IoT: sensori, allarmi, telecamere, caldaie, cancelli. Valido anche per Partita IVA.',
          '⚠️ Voce': '50 minuti solo nazionali (non illimitati).',
          '⚠️ SMS': '50 SMS solo nazionali.',
          'Pagamento': 'Ricarica iniziale 30€. Costi IVA esclusa ad eccezione delle ricariche.',
          'Traffico extra soglia': '30 cent/MB.',
        },
      },
    ],
    fisso: [
      // ══ FTTH ═══════════════════════════════════════════════════════════════
      {
        ...
        dettagli: {
          '🔄 Cos\'è l\'attivazione rateizzata (120€ in 24 mesi)': 'Commissione commerciale di 120€ totali, addebitata a rate di 5€/mese per 24 mesi direttamente in fattura. NON è un anticipo, ma un contributo spalmato nel tempo. Se si recede prima dei 24 mesi, la quota residua viene addebitata in un\'unica soluzione.',
      ...
      {
        id: 'biz-fis-5',
        nome: 'Business Ultrainternet',
        sub: 'FTTC 200 Mega · Solo fisso',
        prezzo: 24.90, label: '24,90€', suf: '+IVA/mese*',
        iva: true, highlight: false,
        tecnologia: 'FTTC',
        features: ['FTTC fino a 200 Mega', 'Chiamate illimitate nazionali', '60 min/mese internazionali'],
        costi: { '🔄 Attivazione commerciale (rateizzata)': '120€ totali → 5€/mese per 24 mesi', '📍 Installazione tecnico': 'Inclusa nel contributo attivazione' },
        dettagli: {
          'Tecnologia': 'FTTC (fibra fino all\'armadio + rame fino alla sede) — fino a 200 Mega in download in base alla distanza dalla centralina.',
          '🔄 Attivazione rateizzata (120€ in 24 mesi)': 'Contributo commerciale di 120€ a rate di 5€/mese per 24 mesi in fattura. Recesso anticipato: quota residua in unica soluzione.',
          'Promozione': 'Primo anno 24,90€. Dal 13° mese: 28,90€+IVA/mese.',
          'IVA': 'Prezzo IVA esclusa (22%).',
        },
        postille: ['* Prezzo promo 24,90€+IVA/mese per i primi 12 mesi. Dal 13° mese: 28,90€+IVA/mese.', 'Installazione: 29,90€ Una Tantum in prima fattura.', 'Attivazione: 120€ totali in 24 rate da 5€/mese — già incluse nel canone.', 'In caso di cessazione entro 24 mesi: rate residue in unica soluzione + 1 mensilità.', 'Tutti i prezzi IVA esclusa (22%).'],
      },
      // ══ CONVERGENTE — BUSINESS FIBRA AFFARI + MOBILE ═══════════════════════
      {
        id: 'biz-fis-2',
        nome: 'Business Fibra Affari + Mobile 500 GB 5G Pro',
        sub: 'FTTH 2.5 Gbps · Convergente · Canone fisso invariato',
        prezzo: 24.90, label: '24,90€', suf: '+IVA/mese fisso',
        iva: true, highlight: true,
        features: ['FTTH 2.5 Gbps · Chiamate illimitate', 'SIM 500 GB 5G: +11€+IVA/mese', 'Canone Fibra invariato anche dopo i primi 12 mesi', 'Senza SIM: 28,90€+IVA/mese'],
        costoTotale: { label: '35,90€+IVA/mese', nota: 'Fisso 24,90€ + SIM 11,00€ (entrambi +IVA)' },
        costi: { '📍 Installazione tecnico fisso (Una Tantum)': '29,90€+IVA', '🔄 Attivazione commerciale': 'Nessun contributo di attivazione rateizzato', 'SIM': '10€', 'Attivazione SIM': 'Gratis', 'Ricarica SIM': '20€', 'SIM mensile': '+11€+IVA/mese' },
        dettagli: {
          'IVA': 'Tutti i prezzi IVA esclusa (22%).',
          '📍 Installazione (29,90€+IVA)': 'Costo Una Tantum per intervento tecnico di posa fibra. Addebitato nella prima fattura.',
          '🔄 Attivazione': 'Per questa offerta convergente NON è previsto alcun contributo di attivazione rateizzato.',
          'Canone invariato': 'Il canone mensile dell\'offerta Fibra rimane invariato anche dopo i primi 12 mesi.',
          'SIM inclusa': 'SIM da 500 GB 5G con minuti illimitati e 100 SMS a +11€+IVA/mese aggiuntivi. Prima ricarica 20€.',
          'Vincolo Mobile': 'In caso di cessazione della linea Mobile associata, il canone della Fibra passerà a 28,90€+IVA/mese.',
        },
        postille: ['* Totale 35,90€+IVA/mese (fisso 24,90€ + SIM 11€). Offerta valida su tecnologia Fibra.', 'Il canone Fibra rimane invariato anche dopo i primi 12 mesi. Nessun contributo di attivazione rateizzato.', 'Installazione fisso: 29,90€+IVA Una Tantum. SIM: 10€ + prima ricarica 20€.', 'Se si disattiva la SIM: il canone fisso passa a 28,90€+IVA/mese.', 'Tutti i prezzi IVA esclusa (22%).'],
      },
      // ══ 2 LINEE VOCE ═══════════════════════════════════════════════════════
      {
        id: 'biz-fis-3',
      ...
      {
        id: 'biz-fwa-5g',
        nome: 'Business FWA 5G',
        sub: 'FWA 5G fino a 300 Mega · Dove la fibra non arriva',
        prezzo: 24.90, label: '24,90€', suf: '+IVA/mese*',
        iva: true, highlight: false,
        tecnologia: 'FWA5G',
        features: ['FWA 5G fino a 300 Mega', 'Chiamate illimitate nazionali · 60 min/mese int.', 'Modem Super Wi-Fi · senza posa cavi'],
        costi: { '📍 Installazione (Una Tantum)': '29,90€+IVA', '🔄 Attivazione commerciale (rateizzata)': '120€ totali → 5€/mese per 24 mesi' },
        dettagli: {
          'Tecnologia': 'FWA 5G — fino a 300 Mega in download in base alla copertura 5G. Ideale per uffici/attività in zone senza FTTH. Verificare sempre la copertura prima di proporre.',
          '🔄 Attivazione rateizzata (120€ in 24 mesi)': 'Contributo commerciale di 120€ a rate di 5€/mese per 24 mesi in fattura.',
          'Promozione': 'Primo anno 24,90€. Dal 13° mese: 28,90€+IVA/mese.',
          'IVA': 'Tutti i prezzi IVA esclusa (22%).',
        },
        postille: ['* Prezzo promo 24,90€+IVA/mese per i primi 12 mesi. Dal 13° mese: 28,90€+IVA/mese.', 'Installazione: 29,90€+IVA Una Tantum. Attivazione: 120€ in 24 rate da 5€/mese.', 'Offerta soggetta a limiti geografici e di copertura 5G.', 'Tutti i prezzi IVA esclusa (22%).'],
      },
    ],
  },
